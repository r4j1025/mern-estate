    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex gap-4 flex-col sm:flex-row'>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <button disabled={loading || uploading} className='text-white p-3 rounded-lg disabled:opacity-80 hover:opacity-80 bg-slate-700 uppercase' >{loading ? "Creating...":" Create Listing"}</button>
